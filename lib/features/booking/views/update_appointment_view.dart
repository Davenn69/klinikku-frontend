...
import 'package:klinikku/features/booking/viewmodels/update_appointment_viewmodel.dart';
...
class UpdateAppointmentView extends StatelessWidget {
  final RegionModel region;
  final DoctorModel doctor;
  final String bookingId;
  final AutoDisposeChangeNotifierProvider<UpdateAppointmentVM> vm;
  ...
  }) : vm = ChangeNotifierProvider.autoDispose(
         (ref) => UpdateAppointmentVM(ref, region: region, doctor: doctor),
       );

  @override
  Widget build(BuildContext context) =>
      BaseView(provider: vm, builder: _buildScreen);

  Widget _buildScreen(BuildContext context, UpdateAppointmentVM vm) => SafeArea(
    bottom: false,
